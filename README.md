...
- **Student-friendly**: Use clear, encouraging language that motivates students (See <attachments> above for file contents. You may not need to search or read the file again.)
